      ...
      <Card>
        <Row gutter={[15,15]}>
          <Col xs={24} sm={24} md={12}>
            <div>
              <h1>Welcome to my profile. I am <br /><span style={{color:"var(--primary-color)"}}>{data?.first_name} {data?.last_name}</span></h1>
              <h4 style={{fontSize:'1.3rem'}}>Contact no : { data?.contact_no }</h4>
              {
