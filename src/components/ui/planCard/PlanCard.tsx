	...
	return (
		<>
			<div className={styles.plan_card_container}>
				...
				<div>
					<hr />
						<p style={{ display: 'flex', gap: '10px', fontWeight: 'bold',alignItems:'center' }}>
						<Image src={plan.agency.profileImg} alt='profile-img' width={40} height={40} style={{borderRadius:'50%'}}/>
						<span style={{ textTransform: 'capitalize' }}>
						{ plan.agency.name}
						</span>
