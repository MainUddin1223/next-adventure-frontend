  ...
  return (
      <div style={{ marginTop: '20px' }}>
          ...
          <Card style={{textAlign:"center"}}>
              <div style={{display:'inline-block',padding:"10px",justifyContent:"center"}}>
              ...
              <div>
                   ...
                   <div>
                              ...
                              <FormTextArea name="review_description" rows={5} placeholder="Write your experiance"/>
            </div>
              </div>
              <Button style={{marginTop:'15px'}} type="primary" htmlType='submit'>Submit</Button>
</div>
              </Card>
              </Form>
    </div>
