	...
	return (
        <div className={styles.container}>
            ...
            <div className={styles.ceo_info}>
                ...
                <p>Unlock Unforgettable Adventures: Explore our platform to discover top-tier tour planners who will not only make your journey worthwhile but also ensure a safe and delightful experience for you.
                </p>
                                <div className={styles.inverted_comma}>
                                                        <Image
