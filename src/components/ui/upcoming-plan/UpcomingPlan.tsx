        ...
        expandedRowRender: (record: DataType) => {
          console.log(record.booking_history)
            const columns: TableColumnsType<ExpandedDataType> = [
              ...
              {
                title: 'Booking Date', dataIndex: 'createdAt',
                render: function (data: any) {
                 return data && dayjs(data).format("DD/MM/YYYY");
                 } },
             { title: 'Total Seats', dataIndex: 'quantity',render: function (data: any) {
               return <strong>{ data } {data>1 ? 'Seats' : 'Seat' }</strong>
                 }  },
                {
                  title: 'Amount',
          ...
          return <Table columns={columns} dataSource={record.booking_history} pagination={ false} />;
    } };
