  ...
  return (
      <>
          ...
          <Card style={{width:"100%"}}>
              {
                  newTags.length ? newTags.map((value,i) => (
                      <Tag  key={i} closeIcon={<CloseCircleOutlined />} onClose={() => {
                             removeTags(value)
                  }}>
                            {value}
                        </Tag>
              ...
              <div style={{display:'flex',gap:"10px",marginTop:"10px"}}>
                  <Input value={tag} placeholder={placeholder} onChange={(e)=>setTag(e.target.value)}/>
